...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///home/dimas/projects/vue-app-test/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/dimas/projects/vue-app-test/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/dimas/projects/vue-app-test/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/dimas/projects/vue-app-test/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/dimas/projects/vue-app-test/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/dimas/projects/vue-app-test/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/dimas/projects/vue-app-test/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/dimas/projects/vue-app-test/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/dimas/projects/vue-app-test/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/dimas/projects/vue-app-test/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/dimas/projects/vue-app-test/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/dimas/projects/vue-app-test/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/dimas/projects/vue-app-test/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/dimas/projects/vue-app-test/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/dimas/projects/vue-app-test/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/dimas/projects/vue-app-test/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/dimas/projects/vue-app-test/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/dimas/projects/vue-app-test/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/dimas/projects/vue-app-test/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/dimas/projects/vue-app-test/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/dimas/projects/vue-app-test/node_modules/vue/index.mjs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/dimas/projects/vue-app-test/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/dimas/projects/vue-app-test/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/dimas/projects/vue-app-test/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/dimas/projects/vue-app-test/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/dimas/projects/vue-app-test/src/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/dimas/projects/vue-app-test","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/dimas/projects/vue-app-test/src/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/dimas/projects/vue-app-test/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/dimas/projects/vue-app-test/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/dimas/projects/vue-app-test/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apiBase": "",
    "recaptchaSiteKey": "6LeFBw4rAAAAAPw0XhKAcJF512YK_CAQPXJMv5vF"
  }
};
const envOptions = {
  prefix: "NITRO_",
...
const _LAwyxXzEpfcUApamLDofI7_bk9e0lw47xg6OByRIJbE = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/dimas/projects/vue-app-test";
...
const _57nxVzd0p4qAeosH4wpeSbMCNUMy9MAa6FpRcycEOWA = (nitroApp) => {
...
const plugins = [
  _LAwyxXzEpfcUApamLDofI7_bk9e0lw47xg6OByRIJbE,
_57nxVzd0p4qAeosH4wpeSbMCNUMy9MAa6FpRcycEOWA
];
...
const _ke79ZA = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/dimas/projects/vue-app-test/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///home/dimas/projects/vue-app-test/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
async function updateArticle(id, userId, title, content, newImageUrl, oldImagePath) {
  ...
  if (newImageUrl && oldImagePath) {
    ...
    await promises.unlink(fullPath).catch(() => {
    });
  }
  return article;
}
async function deleteArticle(id, userId) {
  ...
  if (article.image_url) {
    ...
    await promises.unlink(imagePath).catch(() => {
    });
  }
...
const _id__delete = defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      statusCode,
      statusMessage: (_d = error.message) != null ? _d : "\u041E\u0448\u0438\u0431\u043A\u0430 \u0443\u0434\u0430\u043B\u0435\u043D\u0438\u044F \u0441\u0442\u0430\u0442\u044C\u0438"
    });
  }
});
...
const _id__put = defineEventHandler(async (event) => {
  ...
  const getField = (name) => {
    var _a2, _b2;
    return (_b2 = (_a2 = formData.find((part) => part.name === name && !part.filename)) == null ? void 0 : _a2.data.toString("utf8")) != null ? _b2 : "";
  };
  ...
  if (imagePart && imagePart.filename && imagePart.data) {
    ...
    await promises.writeFile(filePath, imagePart.data);
  ...
  try {
    ...
    throw createError({
      statusCode,
      statusMessage: (_d = error.message) != null ? _d : "\u041E\u0448\u0438\u0431\u043A\u0430 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F \u0441\u0442\u0430\u0442\u044C\u0438"
    });
  }
});
...
const index_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      statusCode,
      statusMessage: (_b = error.message) != null ? _b : "\u041E\u0448\u0438\u0431\u043A\u0430 \u0441\u043E\u0437\u0434\u0430\u043D\u0438\u044F \u0441\u0442\u0430\u0442\u044C\u0438"
    });
  }
});
...
const _id__get = defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      statusCode,
      statusMessage: (_e = error.message) != null ? _e : "\u041E\u0448\u0438\u0431\u043A\u0430 \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u0435\u043D\u0438\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u044B \u0441\u0442\u0430\u0442\u044C\u0438"
    });
  }
});
...
const checkUsername_post = defineEventHandler(async (event) => {
  var _a;
  ...
  try {
    ...
    throw createError({
      statusCode: 400,
      statusMessage: (_a = error.message) != null ? _a : "\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u043E\u0432\u0435\u0440\u043A\u0438 \u0438\u043C\u0435\u043D\u0438 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F"
    });
  }
});

const checkUsername_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: checkUsername_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const login_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    throw createError({
      statusCode: 400,
      statusMessage: (_a = error.message) != null ? _a : "\u041E\u0448\u0438\u0431\u043A\u0430 \u0432\u0445\u043E\u0434\u0430"
    });
  }
});
